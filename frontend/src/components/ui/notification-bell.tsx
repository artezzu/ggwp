...
export default function NotificationBell() {
  ...
  // Получаем URL для навигации по уведомлению
                  ...
                  return (
                    <li key={notification.id} className="border-b border-slate-700 last:border-b-0">
                      <div className="p-3 hover:bg-slate-700 transition-colors flex justify-between items-start">
                        {notificationUrl ? (
                          <Link href={notificationUrl} className="flex-grow cursor-pointer" onClick={() => handleNotificationClick(notification)}>
                            {notificationContent}
                          </Link>
                        ) : (
                        ...
                        <button
                          ...
                          className="p-1 text-gray-400 hover:text-white transition-colors rounded-full hover:bg-slate-600"
